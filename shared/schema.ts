...
export type DhaApplicantBase = typeof dhaApplicants.$inferSelect;
export type DhaDocumentBase = typeof dhaDocuments.$inferSelect;
export type DhaDocumentVerificationBase = typeof dhaDocumentVerifications.$inferSelect;

// Zod schema types
export type DhaApplicantInput = z.infer<typeof insertDhaApplicantSchema>;
export type DhaDocumentInput = z.infer<typeof insertDhaDocumentSchema>;
export type DhaDocumentVerificationInput = z.infer<typeof insertDhaDocumentVerificationSchema>;

// Type aliases for backwards compatibility
export type DhaApplicant = DhaApplicantBase;
export type DhaDocument = DhaDocumentBase;
export type DhaDocumentVerification = DhaDocumentVerificationBase;
export type InsertDhaApplicant = DhaApplicantInput;
export type InsertDhaDocument = DhaDocumentInput;
export type InsertDhaDocumentVerification = DhaDocumentVerificationInput;
